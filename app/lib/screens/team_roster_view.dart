...
///
/// 內嵌在 [ScheduleScreen] 的「個人/全部人」切換器裡，不是獨立頁面/路由，
/// 所以沒有自己的 Scaffold/AppBar，撐滿外層給的空間就好。
class TeamRosterView extends HookConsumerWidget {
          ...
          child: Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => weekStart.value = weekStart.value.subtract(const Duration(days: 7)),
              ),
              Text(
